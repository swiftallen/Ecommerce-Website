    ...
    <div class="container mt-4">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="" method="post" enctype="multipart/form-data">
                            <div class="mb-3">
                                <label for="catname" class="form-label">Upload Category Image</label>
                            ...
                            <div class="mb-3">
                                <label for="catproducts" class="form-label">Number of Products</label>
                                <input type="number" class="form-control" name="catproducts" placeholder="Number of Products" required>
                            </div>
                            <div class="mb-3">
                                <button type="submit" class="btn btn-primary mb-3" name="insert">Insert</button>
                            </div>
                            <?php
                            //insert new category code starts here
                            if (isset($_POST['insert'])) {
                                ...
                                $catproducts = $_POST['catproducts'];
                                $myQuery = "INSERT INTO categories (catimg, catname, catproducts) 
                                VALUES('" . $cat_image . "', '" . $catname . "', '" . $catproducts . "')";
                                $result = mysqli_query($conn, $myQuery);

                                if ($result) {
                                    echo "<script>alert(New Category Inserted Successfully);
        ...
        <div class="table-responsive">
            <table class="table table-hover">
                <thead>
                    <tr>
                        <th class="col">Cat ID</th>
                        <th class="col">Category Image</th>
                ...
                <tbody class="table-group-divider">
                    ...
                    ?>
                        <tr>
                            ...
                            <td><img src="../<?php echo $catArray['catimg'] ?>" width='50px' height='50px;'></td>
                            <td><?php echo $catArray['catname'] ?></td>
                            <td><?php echo $catArray['catproducts'] ?></td>
                            <td>
                                <a href="editCat.php?id=<?php echo $catArray['catid']; ?>" title="Edit/Update"><ion-icon name="create-outline"></ion-icon>
                                    <a href="deleteCat.php?id=<?php echo $catArray['catid']; ?>" title="Delete"><ion-icon name="trash-outline"></ion-icon>
                            </td>
                        </tr>
                    <?php endwhile; ?>
                </tbody>
