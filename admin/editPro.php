...
if (!isset($_SESSION['name'])) {
    ...
    if (is_numeric($id) == true) {
        ...
        while ($prArray = mysqli_fetch_array($result)) {
            $id = $prArray['id']; //product ID or pid
            $catid = $prArray['catid'];
            $pimg = $prArray['pimg'];
            $pname = $prArray['pname'];
            $pnewprice = $prArray['pnewprice'];
            $poldprice = $prArray['poldprice'];
            $star_rating1 = $prArray['star_rating1'];
            $star_rating2 = $prArray['star_rating2'];
            $star_rating3 = $prArray['star_rating3'];
            $star_rating4 = $prArray['star_rating4'];
            $star_rating5 = $prArray['star_rating5'];
            $reviews = $prArray['reviews'];
        }
    } else {
    ...
    <div class="container mt-4">
        <form action="" method="post" enctype='multipart/form-data'>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" value="<?php echo $pimg; ?>" name="pimg">
                <img src="../<?php echo $pimg; ?>" width="40px" height="40px">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name='pnewprice' value="<?php echo $pnewprice; ?>">
            </div>
            <div class="mb-3">
                <label for="poldprice" class="form-label">Product Old pnewprice</label>
                <input type="text" class="form-control" name='poldprice' value="<?php echo $poldprice; ?>">
            </div>
            <div class="mb-3">
        ...
        if (isset($_POST['submit'])) {
            ...
            $pimg = $_POST['pimg']; //initialize variable, global local issue
            ...
            if (!empty($_FILES['file']['name'])) {
                ...
                $pimg = $_POST['pimg']; //fallback to manual path entry
            }
            ...
            $updateQuery = "UPDATE products SET catid = '" . $categoryname . "', pimg = '" . $pimg . "',
            pname='" . $pname . "', pnewprice='" . $pnewprice . "',
            ...
            window.location.href='managePro.php'</script>";
                ...
                echo "<script>alert('Error! Unable to Update Product');
            window.location.href='managePro.php'</script>";
            }
        }
        ?>
